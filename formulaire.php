...
if (!empty($_POST)) {
  ...
  if ($verification === false) {
    ...
    if (!isset($_POST['mdp']) || !preg_match($regexMdp, $_POST['mdp'])) {
      $info .= alert("Le mot de passe doit contenir au moins 8 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial", "danger");
    }
...
<h2 class="display-4 text-center">Inscription joueurs au Club de tennis Fourati</h2>
<?php
echo $info;
?>
